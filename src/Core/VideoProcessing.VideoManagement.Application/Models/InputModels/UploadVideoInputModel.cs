...
public record UploadVideoInputModel
{
    ...
    /// <summary>Quantidade de chunks processados em paralelo para este vídeo (1–100). Opcional; quando informado, o orquestrador usa esse limite.</summary>
    [Description("Chunks em paralelo (1–100)")]
